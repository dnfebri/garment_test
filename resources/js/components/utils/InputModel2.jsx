  ...
  return (
    <div className="pt-4 my-2">
      <label className="relative">
        ...
        <input type={props.type} name={props.name} id={props.id} value={props.value} onChange={props.onChange} className={`w-full bg-transparent focus:ring-0 text-black focus:border-black ${isValue && 'border-black'} h-10 px-2 group-focus:bg-black`} onLoad={inputLoad} onFocus={inputForm} onBlur={outInput} />
      </label> 
    </div>
  )
}
