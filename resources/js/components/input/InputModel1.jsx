  ...
  return (
    <div className="pt-4 my-2">
      <label className="relative">
        ...
        <input type={props.type} name={props.name} id={props.id} value={props.value ? props.value : ''} onChange={props.onChange} className={`w-full bg-transparent focus:ring-0 border-0 border-b text-black dark:text-neutral-200 focus:border-black dark:focus:border-white ${isValue && 'border-black dark:border-neutral-800'} h-10 px-2 group-focus:bg-black`} onLoad={inputLoad} onFocus={inputForm} onBlur={outInput}/>
      </label> 
    </div>
  )
}
